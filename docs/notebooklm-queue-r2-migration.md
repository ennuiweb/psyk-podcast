...
| D2 | planned | Integrate `sync_quiz_links.py` in publish flow | Keep quiz files coherent with current inventory. |
...
| D5 | planned | Define generated-file commit allowlist | Fail closed on unexpected repo dirtiness. |
