...
SHOW_ADAPTERS: dict[str, ShowAdapter] = {
    ...
    "personlighedspsykologi-concept-quizzes": ShowAdapter(
        show_slug="personlighedspsykologi-concept-quizzes",
        subject_slug="personlighedspsykologi",
        discovery_source="auto_spec_rules",
        discovery_path="notebooklm-podcast-auto/personlighedspsykologi/concept_quiz_lab/auto_spec.json",
        generator_script="notebooklm-podcast-auto/personlighedspsykologi/scripts/generate_week.py",
        downloader_script="notebooklm-podcast-auto/personlighedspsykologi/scripts/download_week.py",
        show_config_path="notebooklm-podcast-auto/personlighedspsykologi/concept_quiz_lab/config.json",
        output_root="notebooklm-podcast-auto/personlighedspsykologi/concept_quiz_lab/output",
        prompt_config_path="notebooklm-podcast-auto/personlighedspsykologi/concept_quiz_lab/prompt_config.json",
        config_paths=(
            "notebooklm-podcast-auto/personlighedspsykologi/concept_quiz_lab/auto_spec.json",
