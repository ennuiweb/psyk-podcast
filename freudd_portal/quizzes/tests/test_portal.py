...
"""
    ...
    def test_quiz_wrapper_allows_anonymous_without_pre_summary_login_prompts(self) -> None:
        ...
        self.assertContains(response, "Gå til scoreboard")
    ...
    def test_quiz_wrapper_back_link_falls_back_to_progress_for_external_referer(self) -> None:
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, f'class="ghost-link back-link" href="{reverse("progress")}"')
    ...
    def test_leaderboard_page_hides_participation_status_for_anonymous_users(self) -> None:
        ...
        self.assertEqual(response.status_code, 200)
        self.assertNotContains(response, "Du deltager i scoreboard som")
