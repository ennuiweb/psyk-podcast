...
**Important:** `important_text_mode` is set to `week_x_only`. Priority items must have filenames that start with `W## X` to be highlighted in the feed. The list below uses the intended `W## X` prefixes; rename the files to match when you want the highlights to appear.
...
- Prompts are configured in `shows/personlighedspsykologi/prompt_config.json`.
...
Single-file skips:
- W11: Funch & Roald (2014) chapter
- W17: Jensen (2014)
- W20: Staunæs & Juelskjær (2014)
- W21: Bank (2014)
- W22: Køppe (2014)
- W22: Køppe og Dammeyer (2014b)

Weekly overview skips:
- W11 (missing Funch & Roald 2014)
- W17 (missing Jensen 2014)
- W20 (missing Staunæs & Juelskjær 2014)
- W21 (missing Bank 2014)
- W22 (missing Køppe 2014; Køppe og Dammeyer 2014b)
