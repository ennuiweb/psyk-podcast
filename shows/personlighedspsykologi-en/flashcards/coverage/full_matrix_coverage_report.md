...
|---|---|---:|---:|---|
| `anes_tabel` | `partial` | 13 | 13 | `{'partial': 4, 'strong': 9}` |
| `jaque_orienteringspunkter_narrativ` | `partial` | 2 | 2 | `{'partial': 1, 'strong': 1}` |
| `jaque_tabel_alle_teoretiske_retninger` | `partial` | 9 | 9 | `{'partial': 2, 'strong': 7}` |
| `karla_faenomenologi` | `strong` | 1 | 1 | `{'strong': 1}` |
| `karla_fransk_psykoanalyse` | `strong` | 1 | 1 | `{'strong': 1}` |
| `karla_humanistisk_psyk` | `strong` | 1 | 1 | `{'strong': 1}` |
| `karla_poststrukturalisme` | `strong` | 2 | 2 | `{'strong': 2}` |
| `karla_socialkonstruktivisme` | `strong` | 2 | 2 | `{'strong': 2}` |
| `karla_traekteori` | `partial` | 4 | 4 | `{'partial': 1, 'strong': 3}` |
