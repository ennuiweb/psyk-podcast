...
- Feed output: `gdrive_podcast_feed.py` strips `[EN]` tags from episode titles.
- Week labels follow semester weeks using `feed.semester_week_start_date` (2026-02-02), so lectures 1+2 are both Week 1.
