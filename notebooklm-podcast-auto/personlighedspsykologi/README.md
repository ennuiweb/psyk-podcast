...
This folder contains the generation pipeline assets for Personlighedspsykologi audio production.
...
- `prompt_config.json` - prompts + language variants for NotebookLM
- `sources/` - W## source folders (PDFs, readings)
- `output/` - generated MP3s + request logs
