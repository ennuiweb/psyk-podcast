...
Freudd Portal is the learner-facing home for the study material in this repository. Its purpose is to turn static quiz and podcast content into a continuous learning experience where students can sign in, track what they have done, and follow a clear path through a subject over time.

From a student perspective, it works like a personal study dashboard. You can create an account, pick your semester, and enroll in relevant subjects. The portal then shows your progress through lectures and readings, highlights what is done and what is next, and keeps that state so you can return later without losing momentum.
