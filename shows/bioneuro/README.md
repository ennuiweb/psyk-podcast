...
- `config.r2-pilot.template.json` - non-live R2 pilot template that writes RSS, inventory, quiz links, Spotify map, content manifest, and media manifest under `shows/bioneuro/pilot/` instead of touching the live Drive-backed artifacts.
