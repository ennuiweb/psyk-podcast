...
- Anonymous users can open subject detail directly; adding `?preview=true&lecture=<lecture_key>` enables preview lock mode where rail links to other lectures redirect to login.
