...
class SubjectContentManifestTests(TestCase):
    ...
    def test_build_manifest_maps_standalone_two_part_lydbog_titles_by_reading_descriptor(self) -> None:
        self.rss_file.write_text(
            "\n".join(
                [
                    '<?xml version="1.0" encoding="UTF-8"?>',
        ...
        self.assertEqual(len(reading_podcasts), 1)
        self.assertEqual(reading_podcasts[0]["kind"], "lydbog")
        self.assertEqual(reading_podcasts[0]["title"], "[Lydbog] · Lewis (1999)")
        self.assertEqual(
            reading_podcasts[0]["source_audio_url"],
            "https://example.test/audio/lewis-lydbog.mp3",
        )
    ...
    def test_build_manifest_deduplicates_standalone_two_part_lydbog_titles_without_quiz_link(self) -> None:
        self.rss_file.write_text(
            "\n".join(
                [
                    '<?xml version="1.0" encoding="UTF-8"?>',
