...
- `shows/personlighedspsykologi-en/source_intelligence/course_synthesis.json`
  for course arcs, comparison axes, and weak spots.
- `shows/personlighedspsykologi-en/weekly_overview_summaries.json` for weekly
  Danish overview summaries.
- `shows/personlighedspsykologi-en/reading_summaries.json` for source-level
  reading summaries.
