...
class ResponsiveTemplateRulesTests(SimpleTestCase):
    ...
    def test_base_mobile_navigation_uses_subjects_quiz_cup_and_indstillinger_order_with_icons(self) -> None:
        ...
        self.assertIn("<span class=\"mobile-tab-label\">quizkonkurrencen</span>", body)
        ...
        self.assertLess(mobile_nav.index(">Mine fag</span>"), mobile_nav.index(">quizkonkurrencen</span>"))
        self.assertLess(mobile_nav.index(">quizkonkurrencen</span>"), mobile_nav.index(">Indstillinger</span>"))
    ...
    def test_subject_detail_exposes_desktop_only_quiz_cup_link(self) -> None:
        ...
        self.assertIn("quizkonkurrencen for {{ subject.title|lower }}", body)
    ...
    def test_quiz_wrapper_summary_exposes_quiz_cup_link_and_rank_feedback_hook(self) -> None:
        ...
        self.assertIn("Gå til quizkonkurrencen", body)
